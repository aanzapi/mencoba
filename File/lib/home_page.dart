...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  final Color glassBlack = Colors.black.withOpacity(0.4);
  final Color primaryDark = const Color(0xFF120B0B);
  final Color primaryRed = const Color(0xFF7F1D1D);
  final Color lightRed = const Color(0xFFEF4444);
  final Color cardDark = const Color(0xFF1C0F10);
  final Color cardDarker = const Color(0xFF140A0B);
  ...
  Future<void> _sendBug() async {
    ...
    try {
      final res = await http.get(Uri.parse(
          "http://fantzyganteng.serverku.space:2002/sendBug?key=$key&target=$target&bug=$selectedBugId"));
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: isSelected
                      ? [
                          BoxShadow(
                            color: dangerRed.withOpacity(0.5),
                            blurRadius: 12,
                          )
                        ]
                      : [],
  ...
  return Row(
    ...
    children: List.generate(widget.listBug.length, (index) {
      ...
      return AnimatedContainer(
        ...
        height: 8,
        decoration: BoxDecoration(
          color: isActive ? dangerRed : Colors.white24,
